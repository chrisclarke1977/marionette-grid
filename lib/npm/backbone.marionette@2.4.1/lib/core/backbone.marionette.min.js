    ...
    return f.Error = f.extend.call(Error, {
      ...
      empty: function(a) {
        var b = this.currentView,
            c = f._getValue(a, "preventDestroy", this);
      ...
      _triggerEventOnParentLayout: function(a, b) {
        ...
        if (d) {
          ...
          var h = f.getOption(d, "childEvents"),
              i = d.normalizeMethods(h);
      ...
      getChildViewContainer: function(a) {
        if ("$childViewContainer" in a)
          return a.$childViewContainer;
        var b,
            c = f.getOption(a, "childViewContainer");
        if (c) {
          var d = f._getValue(c, a);
          if (b = "@" === d.charAt(0) && a.ui ? a.ui[d.substr(4)] : a.$(d), b.length <= 0)
            throw new f.Error({
